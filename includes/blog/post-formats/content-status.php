<?php 
	...
	$gvc_post_status_author = isset($values["gvc_post_status_author"][0]) ? $values["gvc_post_status_author"][0] : "";
?>
...
<div class="post-body">
	...
	<?php if (!empty($gvc_post_status_author)) : ?>
		<div class="status-author">
			<?php echo "- ". $gvc_post_status_author; ?>
		</div>
	<?php endif; ?>
