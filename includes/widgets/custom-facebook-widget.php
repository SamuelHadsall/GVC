<?php 
	...
	class WP_Widget_Facebook_Like_Box extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'facebook',
				__('* Facebook Like Box', TEMP_NAME),
				array( 'description' => __('Facebook Like Box widget', TEMP_NAME))
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			$color_scheme = ($gvc['gvc-skin'] && $gvc['gvc-skin'] == "light") ? "light" : "dark";
	 	...
	 	public function form( $instance ) {
	 		...
	 		$defaults = array(
	 			'title'       => __('Find us on Facebook', TEMP_NAME),
	 			'href'        => '',
	 			'app_id'      => '',
	 			'show_faces'  => 'yes',
	 			'show_border' => 'yes',
			...
			<p>
				<label for="<?php echo $this->get_field_id('href'); ?>"><?php echo __( 'Facebook Page URL:', TEMP_NAME ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('app_id'); ?>"><?php echo __( 'App ID from the app dashboard:', TEMP_NAME ); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php echo __( 'Show faces', TEMP_NAME ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_border'); ?>"><?php echo __( 'Show border', TEMP_NAME ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('stream'); ?>"><?php echo __( 'Show stream', TEMP_NAME ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('header'); ?>"><?php echo __( 'Show facebook header', TEMP_NAME ); ?></label>
			</p>
			<?php
		}
