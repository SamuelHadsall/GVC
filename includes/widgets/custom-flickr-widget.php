<?php
	...
	class  WP_Widget_Photos_From_Flickr extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'photos_from_flickr',
				__('* Photos from flickr', TEMP_NAME),
				array( 'description' => __('Display photos from flickr', TEMP_NAME))
			);
		}
		...
		public function widget( $args, $instance ) {
			...
			echo $before_widget;
				...
				$output .='<div class="photos_from_flickr gvc-clearfix">';
	 	...
	 	public function form( $instance ) {
	 		...
	 		$defaults = array(
	 			'title'         => __('Photos from flickr', TEMP_NAME),
	 			'photos_number' => '6',
	 			'flickr_id'     => '',
	 		);
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php echo __( 'Flickr Username:', TEMP_NAME ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'photos_number' ); ?>"><?php echo __( 'Number of photos to show:', TEMP_NAME ); ?></label> 
